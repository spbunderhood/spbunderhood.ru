# http://spbunderhood.ru

Коллективный аккаунт жителей Петербурга, каждую неделю новый петербуржец расскажет о своей жизни в этом замечательном городе.

## Старт проекта

    git clone git@github.com:spbunderhood/spbunderhood.ru.git
    cd spbunderhood.ru
    npm install
    npm start
